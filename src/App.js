        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="bg-gray-100 rounded-lg p-4 mb-6 text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">{basicInfo.experience}</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-5 mb-6">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mb-4 rounded">
                ...
                <p className="text-xs text-amber-700 mt-2 border-t border-amber-200 pt-2">피해야 할 표현: "열심히 했습니다" / "결과가 좋았습니다" — 모두 구체성이 없습니다</p>
              </div>
